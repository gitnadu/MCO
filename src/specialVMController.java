        ...
        this.SVMview.setpurchaseButtonListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (SVMmodel.getCustomizedItem().size() == 0) {
                    if (!(SVMmodel.isChangeEnough(SVMmodel.getStoredCash() - SVMmodel.getSelectedItem().getPrice()))) {
                        SVMview.getStatusSVMTextfield().setText("Insufficient Change!");
                    }
                    else if (!((SVMmodel.getStoredCash() - SVMmodel.getSelectedItem().getPrice()) >= 0)) {
                ...
                {
                    if (!(SVMmodel.isChangeEnough((SVMmodel.getStoredCash() - SVMmodel.getPriceCustomizedItem()))))
                    {
                        SVMview.getStatusSVMTextfield().setText("Insufficient Change");
                    }
                    else if (!((SVMmodel.getStoredCash() - SVMmodel.getPriceCustomizedItem()) >= 0)) {
                        SVMview.getStatusSVMTextfield().setText("Insufficient Funds");
                    } else {
